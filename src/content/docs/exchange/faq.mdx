...
it! We only ask that you abide by the rules and follow whatever do not wants
(DNWs) are present in your recipient's requests concerning dubcon.
...
requested ships and avoid their DNWs.** For more information on DNWs, please see
the [Do Not Want FAQ](#dnw).
...
- **Fanart**
  ...
  - No WIPs are allowed.
  - Artists, please check out [this faq on artist anonymity](#artist).
...
making matches. If matches are not able to be made, we will reach out to you
about potentially editing your requests or offers to help make a match. Please
make sure to keep a close eye on your emails or DMs and respond to them ASAP.
...
<AssignmentsDate client:load />. You can also watch our social media for a post
verifying when assignments have been sent.
...
<DueDate client:load />. That means your content should be in place with tags
and description.
...
reach out to you to take action ASAP.

When works are revealed on <RevealsDate client:load />, you may NOT post about
...
respond to comments and will automatically be marked as "Anonymous".
...
Our social media posts that reveals are complete will include a reminder to do
so!
...
for the next exchange (or possibly any The Hanged Man Club events) until they
comment.
